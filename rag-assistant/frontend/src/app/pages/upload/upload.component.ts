...
@Component({
  ...
  template: `
    <div class="upload-page">
      ...
      <!-- Upload progress -->
      @if (uploading()) {
        <div class="status-bar uploading">Uploading...</div>
      }
      @if (uploadError()) {
        <div class="status-bar error">{{ uploadError() }}</div>
      }
      @if (uploadSuccess()) {
        <div class="status-bar success">Upload successful!</div>
      }
          ...
          @for (doc of documents(); track doc.id) {
            <div class="doc-item">
              <div class="doc-info">
                ...
                <span class="doc-meta">{{ formatSize(doc.file_size) }} · {{ doc.file_type.toUpperCase() }}</span>
              </div>
